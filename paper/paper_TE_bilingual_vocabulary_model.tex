...
\subsection{1.1 Accounts of translation equivalent learning}\label{accounts-of-translation-equivalent-learning}}

\hypertarget{avoidance-account-translation-equivalents-are-harder-to-learn-than-singlets}{%
\subsubsection{1.1.1 Avoidance Account: Translation equivalents are harder to learn than singlets}\label{avoidance-account-translation-equivalents-are-harder-to-learn-than-singlets}}
...
\subsubsection{1.1.2 Preference Account: Translation equivalents are easier to learn than singlets}\label{preference-account-translation-equivalents-are-easier-to-learn-than-singlets}}
...
\subsubsection{1.1.3 Neutral Account: Translation equivalents and singlets are learned similarly}\label{neutral-account-translation-equivalents-and-singlets-are-learned-similarly}}
...
\subsection{1.2 Contributors to translation equivalent knowledge}\label{contributors-to-translation-equivalent-knowledge}}
...
\subsubsection{1.1.1 Vocabulary size in bilinguals' two languages}\label{vocabulary-size-in-bilinguals-two-languages}}
...
\subsubsection{1.1.2 Word learnability as a function of developmental level}\label{word-learnability-as-a-function-of-developmental-level}}
...
\subsection{1.3 The Bilingual Vocabulary Model}\label{the-bilingual-vocabulary-model}}
...
\hspace{1em}NONDOM-SINGLET & Singlets in non-dominant language &  & NONDOM-SINGLET = NONCOM – TE\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Note: } 
...
\subsection{1.4 Current studies}\label{current-studies}}
...
\section{2 Study 1: Simulations}\label{study-1-simulations}}
...
\subsection{2.1 Simulation 1: Children of the same developmental level with different word vocabularies and balances of vocabulary}\label{simulation-1-children-of-the-same-developmental-level-with-different-word-vocabularies-and-balances-of-vocabulary}}
...
\subsection{2.2 Simulation 2: Acquisition of translation equivalents and singlets at different developmental levels}\label{simulation-2-acquisition-of-translation-equivalents-and-singlets-at-different-developmental-levels}}
...
\subsection{2.3 Simulation 3: Bias towards or against translation equivalent learning}\label{simulation-3-bias-towards-or-against-translation-equivalent-learning}}
...
\subsection{2.4 Summary of model predictions}\label{summary-of-model-predictions}}
...
\section{3 Study 2: Empirical data}\label{study-2-empirical-data}}
...
\subsubsection{3.1.1 Participants}\label{participants}}
...
\subsection{3.1.2 Measures}\label{measures}}

\hypertarget{macarthur-bates-communicative-development-inventories-words-and-sentences-cdi}{%
\subsubsection{3.1.2.1 MacArthur-Bates Communicative Development Inventories: Words and Sentences (CDI)}\label{macarthur-bates-communicative-development-inventories-words-and-sentences-cdi}}
...
\subsubsection{3.1.2.2 Language Exposure Questionnaire using the MAPLE approach}\label{language-exposure-questionnaire-using-the-maple-approach}}
...
\subsection{3.1.3 Procedure}\label{procedure}}
...
\subsection{3.2.1 Descriptive measures of vocabulary}\label{descriptive-measures-of-vocabulary}}
...
\subsection{3.2.2 Testing Prediction Set 1: Univariate relationships between translation equivalents and different vocabulary measures}\label{testing-prediction-set-1-univariate-relationships-between-translation-equivalents-and-different-vocabulary-measures}}
...
\subsection{3.2.3 Testing Prediction Set 2: The vocabulary composition of bilingual children at different developmental levels}\label{testing-prediction-set-2-the-vocabulary-composition-of-bilingual-children-at-different-developmental-levels}}
...
\subsection{3.2.4 Testing Prediction Set 3: Rate of translation equivalent learning}\label{testing-prediction-set-3-rate-of-translation-equivalent-learning}}
...
\subsection{4.1 Understanding patterns in bilingual children's vocabulary development}\label{understanding-patterns-in-bilingual-childrens-vocabulary-development}}
...
\subsection{4.2 The status of translation equivalents in bilingual vocabulary development}\label{the-status-of-translation-equivalents-in-bilingual-vocabulary-development}}
...
\subsection{4.3 Assumptions, limitations, and future directions}\label{assumptions-limitations-and-future-directions}}
...
Byers-Heinlein, K., Bergmann, C., \& Savalei, V. (2021). Six solutions for more reliable infant research. \emph{Infant and Child Development}, e2296. \url{https://doi.org/10.1002/icd.2296}
...
\leavevmode\hypertarget{ref-Ronjat_1913}{}%
Ronjat, J. (1913). \emph{Le développement du langage observé chez un enfant bilingue}. Paris: Champion.
...
Trudeau, N., Frank, I., \& Poulin-Dubois, D. (1999). Une adaptation en français {Q}uébécois du {M}acArthur {C}ommunicative {D}evelopment {I}nventory. \emph{La Revue d'orthophonie Et d'audiologie}, \emph{23}, 61--73.
