...
{\centering \includegraphics[width=0.8\linewidth]{paper_TE_bilingual_vocabulary_model_files/figure-latex/fig3-1} 
...
\midrule
\endhead
Age (in month) & 0.95*** & -0.24*** & 0.65*** & 0.69*** & 0.45*** & 0.48*** & 0.65*** & 0.19** & 0.69***\\
LEARNABLE &  & -0.23*** & 0.62*** & 0.65*** & 0.43*** & 0.44*** & 0.62*** & 0.21** & 0.66***\\
...
{\centering \includegraphics[width=0.6\linewidth,height=0.6\textheight]{paper_TE_bilingual_vocabulary_model_files/figure-latex/fig6-1} 
