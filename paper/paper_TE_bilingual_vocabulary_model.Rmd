...
papaja::apa_table(correlation_table,
                  caption = "Pairwise correlations among variables (corrected for multiple comparisons using Benjamini and Yekutieli [2001]).",
...
kable(ws_percentile,
        format = "latex", booktabs = TRUE, align = "c",
        caption = "The number of total English and French productive CDI vocabulary at the 90th percentile at different ages, and the average between the two which serves as the denominator in our computation model.") %>%
